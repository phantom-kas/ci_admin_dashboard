...
<template>
    <div class=" flex flex-row items-start justify-center px-3  py-10  relative h-full">
        <img class=" fixed top-0  left-0 z-10 max-w-[unset] sm:w-[100%]  w-[unset] h-[100vh] lg:h-[unset] lg:w-full  min-h-[100%] lg:min-w-[100%]"
        ...
        <div
            ...
            <IconCi />
            <div class="leading-5 text-center flex flex-col w-full gap-y-3">
                <h1 class="text-3xl font-[500]" v-html="elements.title"></h1>
                <span class=" text-[#7F7E83]" v-html="elements.body"></span>
            </div>
            <router-view @loaded="e=>elements=e"></router-view>
        </div>
    </div>
