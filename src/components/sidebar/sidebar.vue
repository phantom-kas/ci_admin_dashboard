...
<template>
    <div :class="[{ 'open': isOpen }, { ' closed max-sm:border-none!': !isOpen }, { '': isOpen }]"
        class="h-screen  flex flex-col w-sidebar300 rounded-br-lg rounded-tr-lg p-2 text-[16px]  top-0  z-20 ofov bg-blue  dark:bg-black dark:border-neutral-900 dark:border-r">
